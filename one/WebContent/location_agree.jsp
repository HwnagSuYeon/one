...
<body>
	<main class="wrapper">
		<main class="content_wrap">
			<h1 class="title">위치기반 서비스 이용약관</h1>
			<div class="text">
위치기반 서비스 이용약관
제 1장. 총 칙
제 1 조 (목적) 
본 약관은 회원(위치기반 서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다.)이 주식회사 OneForME (이하 "회사"라고 합니다.)이 제공하는 위치기반 서비스(이하 "서비스"라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. 
제 2 조 (이용약관의 효력 및 변경) 
...
1. 상     호 : 주식회사 OneForME
2. 대 표 자 : 임 수 열
3. 주     소 : 서울특별시 성동구 뚝섬로1나길 5, 2층
4. 대표전화 : 02-512-3662
 
<부칙>
제1조 (시행일) 
이 약관은 2019년 03월 15일 부터 시행됩니다.
제2조 
위치정보관리책임자는 2019년 03월 15일 을 기준으로 다음과 같이 지정합니다.
1. 소     속 : API팀
2. 성     명 : 황희
2. 연 락 처 : 062-456-1004
			</div>
		</main>
	</main>
